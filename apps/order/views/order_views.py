...
class OrderListAPIView(APIView):
    ...
    query_filter = {"active_status": "active_status", "status": "status", "action": "action", "instrument": "instrument"}
    ...
    def get(self, request):
        try:
            ...
            filtered_query = self.model_class.objects.filter(build_and_filter(self.query_filter, request.query_params))
